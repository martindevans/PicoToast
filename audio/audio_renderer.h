...
audio_buffer_pool_t *init_audio(int audio_dma_channel)
{
    ...
    audio_buffer_pool_t *producer_pool = audio_new_producer_pool(
        &producer_format,
        AUDIOSYS_NUM_BUFFERS,
        AUDIOSYS_SAMPLES_PER_BUFFER
    );
